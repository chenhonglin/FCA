...
#if defined(CONFIG_BJEVN60_BOARD) || defined(CONFIG_BJEVN60_ED2_BOARD) || defined(CONFIG_BJEVN60_VIRTUAL)
#define PLATFORM_DRIVER_NAME_IVI "synaptics_dsx_ivi"
#endif
...
#if defined(CONFIG_BJEVN60_BOARD) || defined(CONFIG_BJEVN60_ED2_BOARD) || defined(CONFIG_BJEVN60_VIRTUAL)
#define I2C_DRIVER_NAME_IVI "synaptics_dsx_i2c_ivi"
#define I2C_DRIVER_NAME "synaptics_dsx_i2c_vtp"
#else
...
struct synaptics_dsx_board_data {
	...
	int irq;
	unsigned short serializer_i2c_addr;
	unsigned short deserializer_i2c_addr;
};
