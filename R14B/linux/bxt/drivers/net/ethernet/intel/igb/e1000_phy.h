...
struct e1000_xmdio_phy_clause45 {
		u16 func;
		u16 phydev;
		u16 phyreg;
		u16 phydata;
...
#define XMDIO_CMD_DELAY        0
#define XMDIO_CMD_WRITE        1
#define XMDIO_CMD_READ         2
#define XMDIO_CMD_MODI_OR      3
#define XMDIO_CMD_MODI_AND     4
#define XMDIO_CMD_MODI_OR_AND  5
#define XMDIO_CMD_MODI_AND_OR  6
