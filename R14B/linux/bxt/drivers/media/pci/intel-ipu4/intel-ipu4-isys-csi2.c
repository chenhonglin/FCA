...
static bool skip_ev_correction = true;
module_param(skip_ev_correction, bool, S_IRUSR | S_IWUSR | S_IRGRP | S_IWGRP);
MODULE_PARM_DESC(skip_ev_correction, "skips ev correction");
