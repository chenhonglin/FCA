...
static int synaptics_serilizer_init(struct i2c_client *i2c)
{
	...
	dev_err(&i2c->dev,
				"synaptics_serilizer_init: s_i2c %d \n",
				hw_if.board_data->serializer_i2c_addr);
		...
		const struct i2c_device_id *dev_id)
{
	...
	#if defined(CONFIG_BJEVN60_BOARD) || defined(CONFIG_BJEVN60_ED2_BOARD)
