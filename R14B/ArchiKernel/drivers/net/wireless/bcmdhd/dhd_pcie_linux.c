...
#ifndef DHD_DISABLE_SUSPEND_RESUME_CALLBACKS
static int dhdpcie_set_suspend_resume(struct pci_dev *dev, bool state);
#endif /* DHD_DISABLE_SUSPEND_RESUME_CALLBACKS */
...
int dhdpcie_init(struct pci_dev *pdev)
{
	...
	do {
		...
		/* Adding delay before creating virtual interface as we are seeing crash
		* when we do insmod/rmmod continuously. This can be changed later according to platform requirement. */
