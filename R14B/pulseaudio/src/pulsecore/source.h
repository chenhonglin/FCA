...
typedef struct pa_source_spec_mute_dev pa_source_spec_mute_dev;
...
struct pa_source {
    ...
    /* mute all outputs mode */
    bool output_mute_mode;
    /* store the specified mute devices name of source */
    PA_LLIST_HEAD(pa_source_spec_mute_dev, spec_mute_devices);
