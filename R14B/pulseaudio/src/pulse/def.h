...
typedef enum pa_stream_flags {
    ...
    PA_STREAM_NO_MUTE_ALWAYS = 0x100000U
    /**< If a record stream should not be mute always, then set this flag */
...
#define PA_STREAM_NO_MUTE_ALWAYS PA_STREAM_NO_MUTE_ALWAYS
