...
void pa_client_conf_load(pa_client_conf *c, bool load_from_x11, bool load_from_env) {
    ...
    pa_config_item table[] = {
        ...
        { "disable-auth-cookie",    pa_config_parse_bool,     &c->disable_auth_cookie, NULL },
        { NULL,                     NULL,                     NULL, NULL },
    };
...
int pa_client_conf_load_cookie(pa_client_conf *c, uint8_t *cookie, size_t cookie_length) {
    ...
    if (true == c->disable_auth_cookie) {
        pa_log_debug("disable auth cookie! please makesure also config auth-cookie-enabled=0 in native-protocol");
        return -1;
    }
