...
#define PULSEAUDIO_ALSA_OPEN_FAIL_RETRY_CNT             (3)
#define PULSEAUDIO_ALSA_OPEN_FAIL_RETRY_TIME            (100*PA_USEC_PER_MSEC)
#define ALSA_API_FAIL_RETRY_CNT              (5)
#define ALSA_API_FAIL_RETRY_TIME             (500)
