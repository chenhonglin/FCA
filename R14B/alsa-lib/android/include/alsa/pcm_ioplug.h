...
#define SND_PCM_IOPLUG_VERSION_TINY	3	/**< Protocol tiny version */
/**
...
struct snd_pcm_ioplug_callback {
	...
	/**
	 * get the real number of available frames from the plugin; optional since v1.0.3
	 */
	snd_pcm_sframes_t (*get_real_avail)(snd_pcm_ioplug_t *io);
};
