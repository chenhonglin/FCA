...
{
	.name ="Dirana second pin",
	.ops = &skl_pcm_dai_ops,
	.capture = {
		.stream_name = "Dirana Second Capture",
		.channels_min = HDA_8_CH,
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S32_LE ,
...
#ifdef CONFIG_SND_SOC_BJEVN60_ALSA
{
	.name ="Silabs main pin",
	.ops = &skl_pcm_dai_ops,
	.capture = {
		.stream_name = "Silabs Tuner Capture",
		.channels_min = HDA_8_CH,
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S32_LE ,
...
{
	.name = "Cluster Chime Pb pin",
	.ops = &skl_pcm_dai_ops,
	.playback = {
		.stream_name = "Cluster Chime Playback",
		.channels_min = HDA_MONO,
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_8000_192000 | SNDRV_PCM_RATE_KNOT,
		.formats =SNDRV_PCM_FMTBIT_S32_LE,
...
#endif
#ifdef CONFIG_SND_SOC_GWM_V3_ALSA
{
	.name ="Silabs main pin",
	.ops = &skl_pcm_dai_ops,
	.capture = {
...
//Review AudioFO for clean fix in WW05_C
#ifdef CONFIG_DIRANA_DAI_OPS
{
	.name = "Dirana Pb Pin",
	.ops = &skl_pcm_dai_ops,
	.playback = {
