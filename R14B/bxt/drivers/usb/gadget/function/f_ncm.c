...
/* This workaround from Delphi restricts Apple from sending SET_NTB_INPUT_SIZE
 * setup packet from 16384 to 12288. Sometimes this packet is blocking during
 * DATA stage as this data is getting overwritten inside the Unwired hub.
 */
#define NTB_DEFAULT_IN_SIZE	12288
